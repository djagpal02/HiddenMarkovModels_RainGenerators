...
void output(int var, int sites,int days,int states, double means[] )
{
...
int main()
{
    ...
    std::thread first (output,1, sites, days, states, means);
    std::thread second (output,2,sites, days, states, means);
    std::thread third (output,3, sites, days, states, means);
